...
class RNNCNN(lightning.LightningModule):
    ...
    def __init__(
        ...
        self.encoder = nn.Sequential(
            ConvModule(kernel_size, 1, 32, 2, act=act, resunit=2),
            
            ConvModule(kernel_size, 32, 64, 2, act=act, resunit=2),
            ConvModule(kernel_size, 64, 128, 2, act=act, resunit=2),

            ConvModule(kernel_size, 128, 256, 2, act=act, resunit=2),

            ConvModule(kernel_size, 256, 512, 2, act=act, resunit=2),
